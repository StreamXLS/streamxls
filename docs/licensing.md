...
The StreamXLS binary product — the registered COM component and its supporting installer — is **not** open source. Source code is not published. Binary distribution is governed by the End-User License Agreement that ships with the installer.

## Commercial inquiries

Three categories of inquiry are welcome via [GitHub Discussions](https://github.com/StreamXLS/streamxls/discussions) → **Commercial inquiries**:
